      ...
      <div className="container relative z-10 px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-3 lg:ml-auto">
            ...
            <div className="space-y-5">
              ...
              <ul className="space-y-4">
                <li><Link to="/docs" className="text-sm text-slate-400 hover:text-blue-400 transition-colors inline-block transform hover:translate-x-1 duration-200">Documentation</Link></li>
                <li><Link to="/blog" className="text-sm text-slate-400 hover:text-blue-400 transition-colors inline-block transform hover:translate-x-1 duration-200">Blog</Link></li>
                <li><Link to="/careers" className="text-sm text-slate-400 hover:text-blue-400 transition-colors inline-block transform hover:translate-x-1 duration-200">Careers</Link></li>
                <li><Link to="/status" className="text-sm text-slate-400 hover:text-blue-400 transition-colors inline-block transform hover:translate-x-1 duration-200">API Status</Link></li>
              </ul>
            </div>
            ...
            <div className="space-y-5">
              ...
              <ul className="space-y-4">
                <li><Link to="/privacy" className="text-sm text-slate-400 hover:text-blue-400 transition-colors inline-block transform hover:translate-x-1 duration-200">Privacy Policy</Link></li>
                <li><Link to="/terms" className="text-sm text-slate-400 hover:text-blue-400 transition-colors inline-block transform hover:translate-x-1 duration-200">Terms of Service</Link></li>
                <li><Link to="/cookies" className="text-sm text-slate-400 hover:text-blue-400 transition-colors inline-block transform hover:translate-x-1 duration-200">Cookie Policy</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            <a href="https://github.com/skillsphere-ai" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-slate-900 border border-slate-800 text-slate-400 hover:text-white hover:border-slate-700 hover:bg-slate-800 transition-all transform hover:-translate-y-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.02c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
            </a>
            <a href="https://twitter.com/skillsphereai" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-slate-900 border border-slate-800 text-slate-400 hover:text-blue-400 hover:border-slate-700 hover:bg-slate-800 transition-all transform hover:-translate-y-1">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
            </a>
            <a href="https://linkedin.com/company/skillsphereai" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-slate-900 border border-slate-800 text-slate-400 hover:text-blue-500 hover:border-slate-700 hover:bg-slate-800 transition-all transform hover:-translate-y-1">
